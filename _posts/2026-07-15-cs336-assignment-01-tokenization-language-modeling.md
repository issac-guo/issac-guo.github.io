...
## 1.1 Download Start Code and Dataset {#download-start-code-and-dataset}
...
# 2 Part 01: Byte Pair Encoding (BPE) Implementation {#part-01-byte-pair-encoding-bpe-implementation}
...
## 2.1 BPE Algorithm Recap {#sec-bpe-recap}
...
## 2.3 Pre-Processing {#pre-processing}
...
### 2.3.1 Special Tokens Based Splitting {#special-tokens-based-splitting}
...
### 2.3.2 Regex-based Splitting (Pre-Tokenization) {#regex-based-splitting-pre-tokenization}
...
### 2.3.3 Multi-Processing {#multi-processing}
...
## 2.4 BPE Version 1: Using Heap {#bpe-version-1-using-heap}
...
## 2.5 BPE Version 2: Using Heap + Indexing {#bpe-version-2-using-heap-indexing}
...
## 2.7 BPE on TinyStory {#bpe-on-tinystory}
...
## 2.8 BPE Tokenizer {#bpe-tokenizer}
...
### 2.8.1 Encode in BPETokenizer {#encode-in-bpetokenizer}
...
## 2.9 Tokenize and Save File {#tokenize-and-save-file}
...
## 2.10 Part 01 Summary {#part-01-summary}
...
# 3 Part 02: Language Model Implementation {#part-02-language-model-implementation}
...
## 3.1 Linear Module {#linear-module}
...
## 3.2 Embedding Model {#embedding-model}
...
## 3.4 PointWise Feed Forward Network {#pointwise-feed-forward-network}
...
## 3.6 Multi-Headed Attention {#multi-headed-attention}

接下来，我们来实现Transformer中，最重要也是相对比较复杂的部分，Attention，我们先来看看什么是Scaled Dot Product Attention

### 3.6.1 Scaled Dot-Product Attention {#scaled-dot-product-attention}
...
#### 3.6.1.1 Softmax Function {#softmax-function}
...
#### 3.6.1.2 Scaled Dot Product Attention {#scaled-dot-product-attention-1}
...
#### 3.6.1.3 Causal Masking {#causal-masking}
...
### 3.6.2 Multi Headed Attention {#multi-headed-attention-1}
...
### 3.6.3 Shape Transformations in Attention {#shape-transformations-in-attention}
...
### 3.6.4 RoPE in Attention {#rope-in-attention}
...
## 3.7 Transformer Block {#transformer-block}
...
### 3.8.1 Weight Tying {#weight-tying}
...
## 3.9 Full Transformer Model {#full-transformer-model}
...
## 3.10 Part 02 Summary {#part-02-summary}
...
## 4.2 Optimizer & Learning Rate Scheduler {#optimizer-learning-rate-scheduler}
...
### 4.2.2 Cosine Annealing Learning Rate Scheduler {#cosine-annealing-learning-rate-scheduler}
...
### 4.2.3 Gradient Clipping {#gradient-clipping}
...
### 4.2.4 Put Together {#put-together}
...
## 4.5 Training Looping {#training-looping}
...
# 5 Part 04: Generation {#part-04-generation}
...
## 5.1 Greedy Sampling {#greedy-sampling}
...
## 5.2 Top-K Sampling {#top-k-sampling}
...
## 5.3 Top-P Sampling {#top-p-sampling}
...
## 5.5 Part 04 Summary {#part-04-summary}
...
# 6 Part 05: Experiments {#part-05-experiments}
